      ...
      <section className="px-5 md:px-10 py-[70px]">
        <div className="container mx-auto space-y-[50px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 auto-rows-auto">
            ...
            <FadeIn delay={0.1} direction="up" className="bg-[#F5F7FB] rounded-md p-5 flex flex-col justify-between gap-16">
            ...
            <FadeIn delay={0.2} direction="up" className="bg-[#F5F7FB] rounded-md p-5 flex flex-col justify-between gap-16">
              <div className="bg-linear-to-r from-[#006979] to-[#00434D] p-3.5 rounded-full w-fit">
      ...
      <section className="px-5 md:px-10 py-[70px]">
        <div className="container mx-auto space-y-[50px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 auto-rows-auto">
            ...
            <FadeIn delay={0.1} direction="up" className="bg-[#F5F3FF] rounded-md flex flex-col gap-6 justify-between p-5 pb-0">
              <div className="bg-linear-to-r from-[#006979] to-[#00434D] p-3.5 rounded-full w-fit">
            ...
            <FadeIn delay={0.2} direction="up" className="bg-[#F5F3FF] rounded-md flex flex-col gap-6 justify-between p-5 pb-0">
              <div className="bg-linear-to-r from-[#006979] to-[#00434D] p-3.5 rounded-full w-fit">
            ...
            <FadeIn delay={0.3} direction="up" className="bg-[#F5F3FF] rounded-md flex flex-col gap-6 justify-between p-5 pb-0">
              <div className="bg-linear-to-r from-[#006979] to-[#00434D] p-3.5 rounded-full w-fit">
